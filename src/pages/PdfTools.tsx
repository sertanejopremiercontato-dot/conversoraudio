...
export default function PdfTools({ activeTool: propActiveTool, setActiveTool: propSetActiveTool, onNavigate }: PdfToolsProps = {}) {
            ...
            <div 
              ...
              onClick={() => {
                if (onNavigate) {
                  ...
                  window.history.pushState({}, "", "/pdf/extrair-texto");
