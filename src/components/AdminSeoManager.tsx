          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-xs">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                placeholder="https://multiconverte.com.br"
                className="w-full bg-card-main border border-border-main rounded-xl px-4 py-2.5 text-text-main font-medium focus:outline-none focus:border-green-primary"
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-xs">
            ...
            <div className="md:col-span-2 space-y-1.5">
              ...
              <input
                ...
                placeholder="https://multiconverte.com.br/multiconverte-og-image.png"
                className="w-full bg-card-main border border-border-main rounded-xl px-4 py-2.5 text-text-main font-medium focus:outline-none focus:border-green-primary"
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
            ...
            <div className="md:col-span-2 space-y-1.5 pt-2">
              ...
              <input
                ...
                placeholder="https://multiconverte.com.br/sitemap.xml"
                className="w-full bg-card-main border border-border-main rounded-xl px-4 py-2.5 text-text-main font-medium focus:outline-none focus:border-green-primary"
              />
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-xs">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    placeholder="https://multiconverte.com.br/rota"
                    className="w-full bg-card-main border border-border-main rounded-xl px-4 py-2.5 text-text-main font-medium focus:outline-none focus:border-green-primary"
                  />
                </div>
